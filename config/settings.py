...
MAX_FILES_PER_REPO: int = int(os.getenv("MAX_FILES_PER_REPO", "75"))
MAX_FILE_SIZE_KB: int = int(os.getenv("MAX_FILE_SIZE_KB", "300"))
MAX_LINES_PER_FILE: int = int(os.getenv("MAX_LINES_PER_FILE", "600"))
